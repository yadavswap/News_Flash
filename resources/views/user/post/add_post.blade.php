                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="box box-info">
                                            <!-- /.box-header -->
                                            <!-- form start -->
                                            <form action="{{route('save-new-post')}}" method="post" enctype="multipart/form-data" id="add_post">
                                                @csrf
                                                <div class="box-body">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <label>Select Multiple Images <small style="font-size: 12px;">(First image will be featured on your App)</small></label>
