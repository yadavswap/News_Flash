                    ...
                    <div class="col-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body" style="display: block;">
                                ...
                                <div class="sharethis-inline-share-buttons" data-url="{{url('post')}}/{{$post->pid}}" data-title="{{$post->title}}" data-image="http://newskatta.in/posts/2012186335520121721032news%20%20katta.png"
                                    ></div>
                            </div>
                            <!-- /.card-body -->
